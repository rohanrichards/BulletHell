...
{
    public override void Fire(WeaponSO weaponConfig, Entity bulletPrefab)
    {
        ...
        for (int i = 0; i < weaponConfig.ProjectileCount; i++)
        {
            ...
            Entity bullet = BulletBase.CreateEntity(bulletPrefab, playerLocation, originOffset, Quaternion.Euler(rotation), offsetVector, playerVelocity, weaponConfig);
        }
